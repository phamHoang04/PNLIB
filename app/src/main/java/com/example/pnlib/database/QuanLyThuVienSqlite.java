...
public class QuanLyThuVienSqlite extends SQLiteOpenHelper {
   ...
   static final int dbVersion = 1;
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        //inert du lieu mau
        String insThuThu = "INSERT INTO THUTHU VALUES('tt1','Pham Huy Hoang 1', 'tt123'),('tt2','Pham Huy Hoan 2', 'tt125'),('tt3','Pham Huy Hoang 3', 'tt345'),('admin','hoangphph35249', 'ph35249')";
